...
module.exports = {
	data: new SlashCommandBuilder()
        ...
        .addUserOption(option => option.setName('user').setDescription('User to transfer currency to'))
        .addIntegerOption(option => option.setName('amount').setDescription('Amount to transfer')),
